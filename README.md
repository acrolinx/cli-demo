...
* Goto `Control Panel\All Control Panel Items\System` ![Control Panel / System](doc/advanced_system_settings.png).
* Open `Advanced system settings`: ![Environment Variables](doc/env.png).
* Click `New...` in either user or system variables, and enter the values: ![Environment Variables](doc/new_env.png).
